...
class Protagonist {
    ...
    public: 
        ...
        void addBild() {
            ...
            //Bilder beim Laufen
            bild[0][0] = Image("laufen1_2.png",x,y,80,80,spielfeld);
            bild[0][1] = Image("laufen2_2.png",x,y,80,80,spielfeld);
            bild[0][1].hide();
            
            // Bilder im (Super-)Sprung
            bild[1][0] = Image("sprung2.png",x,y,80,80,spielfeld);
            bild[1][0].hide();
            bild[1][1] = Image("superSprung2.png",x,y,80,80,spielfeld);
            bild[1][1].hide();
            
            // Bild beim "Kriechen"
            bild[2][0] = Image("kriechen2.png",x,y,50,50,spielfeld);
            bild[2][0].hide();
            
            // Bild im Zerstörer-Modus
            bild[3][0] = Image("zerstoerer2.png",x,y,80,80,spielfeld);
            bild[3][0].hide();
